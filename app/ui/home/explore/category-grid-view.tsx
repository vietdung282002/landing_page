    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3 gap-4 w-full mt-25 2xl:mt-0">
      {categories.map((category) => (
        ...
        >
          ...
          />
          <div className="absolute inset-0 bg-gray-300/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center gap-9">
          ...
          <div className="block 2xl:hidden absolute inset-0 opacity-100 group-hover:opacity-0 transition-opacity duration-300 flex flex-col items-center justify-center gap-9">
            <h3 className="text-[36px] md:text-[48px] 2xl:text-[64px] font-normal leading-21 text-white">
              {category.name}
            </h3>
